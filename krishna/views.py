...
def staff_log_sign_page(request):
    if request.method == 'POST':
        ...
        if user.is_staff:
            ...
            return redirect('staffloginpage')
    response = render(request,'staff/stafflogin.html')
    return HttpResponse(response)
...
def panel(request):
    ...
    response = render(request,'staff/staffpanel.html',{'location':hotel,'reserved':reserved,'rooms':rooms,'total_rooms':total_rooms,'available':available_rooms,'unavailable':unavailable_rooms})
    return HttpResponse(response)
...
def edit_room(request):
    ...
    if request.method == 'POST' and request.user.is_staff:
        ...
        response = render(request,'staff/editable.html',{'room':room})
        return HttpResponse(response)
...
def book_room_page(request):
    ...
    return HttpResponse(render(request,'user/bookings.html',{'room':room}))
...
def view_room(request):
    ...
    return HttpResponse(render(request,'staff/staffview.html',{'room':room,'reservations':reservation}))
